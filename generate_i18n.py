...
LANGS = {
    "sk": {
        ...
        "hero_soft_row": "POHODA · Money S3 · MRP · OMEGA · ISDOC",
        ...
        "year_price": "9,99€",
        "year_period": "/ rok",
        "year_desc": "Pre podnikateľov s menším množstvom dokladov — až 50 dokladov ročne.",
    ...
    "cs": {
        ...
        "year_price": "9,99€",
        "year_period": "/ rok",
        "year_desc": "Pro podnikatele s menším množstvím dokladů — až 50 dokladů ročně.",
        ...
        "compat_items": [
            ...
            ("MRP — XML 2.0", "/navod-importu/mrp.html"),
            ("OMEGA — TXT", "/navod-importu/omega.html"),
            ("OBERON — XML · připravujeme", "/navod-importu/"),
            ("Ostatní softwary — ISDOC a CSV", "/navod-importu/"),
        ],
        "nav_guides": "Návod importu",
        "compat_cta": "Ukázat účetnímu, jak importovat doklady →",
        "compat_cta_sub": "Screenshoty a postup pro POHODA, Money S3, MRP a OMEGA.",
    ...
    "de": {
        ...
        "compat_items": [
            ...
            ("MRP — XML 2.0", "/navod-importu/mrp.html"),
            ("OMEGA — TXT", "/navod-importu/omega.html"),
            ("OBERON — XML · in Vorbereitung", "/navod-importu/"),
        ...
        "compat_cta_sub": "Screenshots und Anleitung für POHODA, Money S3, MRP und OMEGA.",
